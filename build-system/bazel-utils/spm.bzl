...
_IGNORE_CC_LIBRARY_ATTRS = [
    "data", "applicable_licenses", "alwayslink", "aspect_hints",
    "compatible_with", "deprecation", "exec_compatible_with",
    "exec_properties", "expect_failure", "features",
    "generator_function", "generator_location", "generator_name",
    "generator_platform", "generator_script", "generator_tool",
    "generator_toolchain", "generator_toolchain_type", "licenses",
    "linkstamp", "linkstatic", "name", "restricted_to",
    "target_compatible_with", "testonly", "to_json", "to_proto",
    "toolchains", "transitive_configs", "visibility", "win_def_file",
    "linkopts",
]

_IGNORE_CC_LIBRARY_EMPTY_ATTRS = [
    "additional_compiler_inputs", "additional_linker_inputs",
    "hdrs_check", "implementation_deps", "include_prefix",
    "strip_include_prefix", "local_defines", "conlyopts",
    "module_interfaces", "package_metadata",
]

_CC_LIBRARY_ATTRS = {
    "copts": [], "cxxopts": [], "defines": [], "deps": [],
    "hdrs": [], "includes": [], "srcs": [], "textual_hdrs": [],
}

_CC_LIBRARY_REQUIRED_ATTRS = {}

_IGNORE_OBJC_LIBRARY_ATTRS = [
    "data", "alwayslink", "applicable_licenses", "aspect_hints",
    "compatible_with", "enable_modules", "exec_compatible_with",
    "exec_properties", "expect_failure", "features",
    "generator_function", "generator_location", "generator_name",
    "deprecation", "module_name", "name", "stamp", "tags",
    "target_compatible_with", "testonly", "to_json", "to_proto",
    "toolchains", "transitive_configs", "visibility", "package_metadata",
]

_IGNORE_OBJC_LIBRARY_EMPTY_ATTRS = [
    "implementation_deps", "linkopts", "module_map", "non_arc_srcs",
    "pch", "restricted_to", "textual_hdrs", "sdk_includes", "conlyopts",
]

_OBJC_LIBRARY_ATTRS = {
    "copts": [], "cxxopts": [], "defines": [], "deps": [],
    "hdrs": [], "srcs": [], "sdk_dylibs": [], "sdk_frameworks": [],
    "weak_sdk_frameworks": [], "includes": [],
}

_OBJC_LIBRARY_REQUIRED_ATTRS = ["module_name"]

_IGNORE_SWIFT_LIBRARY_ATTRS = [
    "data", "always_include_developer_search_paths", "alwayslink",
    "applicable_licenses", "aspect_hints", "compatible_with",
    "deprecation", "exec_compatible_with", "exec_properties",
    "expect_failure", "features", "generated_header_name",
    "generates_header", "generator_function", "generator_location",
    "generator_name", "linkstatic", "module_name", "name",
    "package_name", "restricted_to", "tags", "target_compatible_with",
    "testonly", "to_json", "to_proto", "toolchains",
    "transitive_configs", "visibility", "library_evolution",
    "package_metadata",
]

_IGNORE_SWIFT_LIBRARY_EMPTY_ATTRS = [
    "plugins", "private_deps", "swiftc_inputs",
]

_SWIFT_LIBRARY_ATTRS = {
    "copts": [], "defines": [], "deps": [], "linkopts": [], "srcs": [],
}

_SWIFT_LIBRARY_REQUIRED_ATTRS = ["module_name"]

_IGNORE_APPLE_STATIC_XCFRAMEWORK_IMPORT_ATTRS = [
    "name", "alwayslink", "aspect_hints", "compatible_with", "data",
    "deprecation", "exec_compatible_with", "exec_properties",
    "expect_failure", "features", "generator_function",
    "generator_location", "generator_name", "has_swift", "includes",
    "library_identifiers", "linkopts", "package_metadata",
    "restricted_to", "tags", "target_compatible_with", "testonly",
    "toolchains", "transitive_configs", "visibility",
    "weak_sdk_frameworks",
]

_IGNORE_APPLE_STATIC_XCFRAMEWORK_IMPORT_EMPTY_ATTRS = [
    "deps", "sdk_dylibs", "sdk_frameworks",
]

_APPLE_STATIC_XCFRAMEWORK_IMPORT_ATTRS = ["xcframework_imports"]

_APPLE_STATIC_XCFRAMEWORK_IMPORT_REQUIRED_ATTRS = ["xcframework_imports"]
    ...
    if rule.kind in _LIBRARY_CONFIGS:
        ...
        for attr_name in handled_attrs:
            if hasattr(rule.attr, attr_name):
                ...
                result[attr_name] = handled_attrs[attr_name]
...
def _generate_spm_impl(ctx):
    ...
    ctx.actions.write(
        ...
        content = json.encode_indent(modules, indent = "  "),
    )
